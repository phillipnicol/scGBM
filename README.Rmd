...
The heatmap shows there is significant overlap between the clusters. This makes sense because the data was simulated to have no latent variability. The CCI function also returns a `coarse_cluster` which combines clusters that have high inter-CCI. Here it correctly identifies that there is only one "true" cluster.
